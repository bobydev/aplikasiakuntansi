...
Route::get('inputbarang', [App\Http\Controllers\BarangController::class, 'create'])->name('barang.inputbarang');
Route::post('barang.store', [App\Http\Controllers\BarangController::class, 'store'])->name('barang.store');
Route::get('editbarang/{id}', [App\Http\Controllers\BarangController::class, 'edit'])->name('barang.editbarang/{id}');
Route::post('barang.update', [App\Http\Controllers\BarangController::class, 'update'])->name('barang.update');
Route::get('barang/destroy/{id}', [App\Http\Controllers\BarangController::class, 'destroy'])->name('barang.destroy/{id}');

Route::resource('baranglaku', 'BarangLakuController');
Route::get('baranglaku', [App\Http\Controllers\BarangLakuController::class,'index'])->name('baranglaku');
Route::get('inputbaranglaku', [App\Http\Controllers\BarangLakuController::class, 'create'])->name('baranglaku.inputbaranglaku');
Route::post('baranglaku.store', [App\Http\Controllers\BarangLakuController::class, 'store'])->name('baranglaku.store');
Route::get('editbaranglaku/{id}', [App\Http\Controllers\BarangLakuController::class, 'edit'])->name('baranglaku.editbaranglaku/{id}');
Route::post('baranglaku.update', [App\Http\Controllers\BarangLakuController::class, 'update'])->name('baranglaku.update');
Route::get('baranglaku/destroy/{id}', [App\Http\Controllers\BarangLakuController::class, 'destroy'])->name('baranglaku.destroy/{id}');
...
Route::get('laporan.baranglaku_pdf', [App\Http\Controllers\LaporanController::class, 'show'])->name('laporan.baranglaku_pdf');
