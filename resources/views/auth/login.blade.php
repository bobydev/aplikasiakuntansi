										...
										<div class="text-center">
											...
											<form method="POST" action="{{ route('login') }}">
												...
												<div class="form-group row text-white">
													<label for="email" class="col-md-12 col-form-label text-white-md-left">{{ __('E-Mail') }}</label>
													<div class="col-md-12">
														<input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Isikan e-mail kamu yang sudah terdaftar yaa">
															@error('email')
												...
												<div class="form-group row text-white">
                            						<label for="password" class="col-md-12 col-form-label text-white-md-left">{{ __('Password') }}</label>
                            					<div class="col-md-12">
                                					<input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Isikan password-mu yang sudah terdaftar juga yaa">
							                                @error('password')
                            							        <span class="invalid-feedback" role="alert">
                                        							<strong>{{ $message }}</strong>
                                    							</span>
