...
<div class="container"> 
	<div class="row justify-content-center"> 
		<div class="col-md-12"> 
			...
			<div class="card-body"> 
				<form action="{{route('laporan.baranglaku_pdf')}}" method="PUT" target="_blank"> 
					@csrf 
					<fieldset class="ml-md-3"> 
						<div class="form-group row"> 
							<div class="col-md-4"> 
								<label for="jenis">Periode Transaksi Penjualan</label> 
								<input id="jenis" type="hidden" name="jenis" value="baranglaku" class="form-control"> 
							...
							<div class="col-md-10"> 
								<input type="submit" class="btn btn-danger btn-send" value="Cetak" > 
							</div> 
						</fieldset> 
					</form> 
				</div> 
			</div>
			<hr class="12 btn-danger">
			<div class="card"> 
			<div class="card-header">Laporan Keuangan Buku Besar</div> 
			<div class="card-body"> 
			...
			<div class="card"> 
				<div class="card-header">Laporan Keuangan Transaksi Kas Masuk</div> 
				<div class="card-body"> 
			...
			<div class="card"> 
				<div class="card-header">Laporan Keuangan Transaksi Kas Keluar</div> 
				<div class="card-body"> 
