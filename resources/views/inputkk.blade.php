...
@csrf
	<fieldset>
 		...
 		<div class="form-group row">
 			<div class="col-md-10">
 				Memo<textarea id="memo" type="text" name="memo" class="formcontrol" required></textarea>
 			</div>
 		</div>
 		...
 		<div class="form-group row">
 			...
 			<div class="col-md-4">
 				Jumlah Pengeluaran
 				@for($i=1;$i<=3;$i++)
 					<input id="txt{{$i}}" type="text" name="txt{{$i}}" class="formcontrol" value="0" onkeyup="sum();">
				endfor
 				<input id="idkk" type="hidden" name="idkk" class="formcontrol" value="{{$nomorawal}}" required>
 			</div>
 		</div>
 		<div class="form-group row">
 			<div class="col-md-10">Total Pengeluaran
 				<input id="total" type="text" name="total" class="formcontrol" required>
 			</div>
 		</div>
 		<div class="form-group row">
 		<div class="col-md-10">
